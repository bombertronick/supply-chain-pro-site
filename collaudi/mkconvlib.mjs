...
const src = readFileSync(process.argv[2] || "../app-dev.jsx", "utf8") +
  "\nexport { gnFrazione, domandaConv, convDaRisposta, coppieConv, convStimata, sfoltisciMov, registraMov, SETT_USCITE, MAX_ALTRI_MOV, MAX_USCITE_MOV, USCITE_STORICO, soglieConsigliate };\n";
