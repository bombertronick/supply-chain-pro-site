...
/* gen-5.57 — tre lavori:
   ...
   I pezzi stanno in h560/NNa.txt (vecchio) e h560/NNb.txt (nuovo) invece che
...
writeFileSync("pairs560.json", JSON.stringify(P));
console.log("scritto app-dev.jsx e pairs560.json");
