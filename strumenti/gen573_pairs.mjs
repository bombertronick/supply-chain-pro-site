...
const src = readFileSync("app-gen572.jsx", "utf8");
const numeri = ["10", "20"];
let ok = true;
const pezzi = [];
for (const n of numeri) {
  const a = readFileSync(`h573/${n}a.txt`, "utf8");
  const b = readFileSync(`h573/${n}b.txt`, "utf8");
...
out += src.slice(cur);
if (!existsSync("app-gen573.jsx")) { writeFileSync("app-gen573.jsx", out); console.log("scritto app-gen573.jsx"); }
const atteso = readFileSync("app-gen573.jsx", "utf8");
console.log("ricostruzione identica a app-gen573.jsx:", out === atteso, "| len", out.length);
