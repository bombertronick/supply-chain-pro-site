...
const src = readFileSync("app-gen566.jsx", "utf8");
const numeri = ["10", "20", "30", "40", "50", "60", "70"];
let ok = true;
const pezzi = [];
for (const n of numeri) {
  const a = readFileSync(`h567/${n}a.txt`, "utf8");
  const b = readFileSync(`h567/${n}b.txt`, "utf8");
...
out += src.slice(cur);
const atteso = readFileSync("app-gen567.jsx", "utf8");
console.log("ricostruzione identica a app-gen567.jsx:", out === atteso, "| len", out.length);
