...
const src = readFileSync("app-gen571.jsx", "utf8");
const numeri = ["10", "20", "30", "40", "50", "60"];
let ok = true;
const pezzi = [];
for (const n of numeri) {
  const a = readFileSync(`h572/${n}a.txt`, "utf8");
  const b = readFileSync(`h572/${n}b.txt`, "utf8");
...
out += src.slice(cur);
if (!existsSync("app-gen572.jsx")) { writeFileSync("app-gen572.jsx", out); console.log("scritto app-gen572.jsx"); }
const atteso = readFileSync("app-gen572.jsx", "utf8");
console.log("ricostruzione identica a app-gen572.jsx:", out === atteso, "| len", out.length);
