...
const src = readFileSync("app-prod.jsx", "utf8");
const numeri = ["10", "20"];
let ok = true;
const pezzi = [];
for (const n of numeri) {
  const a = readFileSync(`h565/${n}a.txt`, "utf8");
  const b = readFileSync(`h565/${n}b.txt`, "utf8");
...
out += src.slice(cur);
const atteso = readFileSync("app-gen565.jsx", "utf8");
console.log("ricostruzione identica a app-gen565.jsx:", out === atteso, "| len", out.length);
