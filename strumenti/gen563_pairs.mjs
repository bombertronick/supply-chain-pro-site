...
/* gen-5.57 — tre lavori:
   ...
   I pezzi stanno in h563/NNa.txt (vecchio) e h563/NNb.txt (nuovo) invece che
...
writeFileSync("pairs563.json", JSON.stringify(P));
console.log("scritto app-dev.jsx e pairs563.json");
