...
const src = readFileSync("app-gen569.jsx", "utf8");
const numeri = ["10", "20", "30", "40", "50"];
let ok = true;
const pezzi = [];
for (const n of numeri) {
  const a = readFileSync(`h570/${n}a.txt`, "utf8");
  const b = readFileSync(`h570/${n}b.txt`, "utf8");
...
out += src.slice(cur);
const atteso = readFileSync("app-gen570.jsx", "utf8");
console.log("ricostruzione identica a app-gen570.jsx:", out === atteso, "| len", out.length);
