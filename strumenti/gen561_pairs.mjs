...
/* gen-5.57 — tre lavori:
   ...
   I pezzi stanno in h561/NNa.txt (vecchio) e h561/NNb.txt (nuovo) invece che
...
writeFileSync("pairs561.json", JSON.stringify(P));
console.log("scritto app-dev.jsx e pairs561.json");
