...
_Aggiornata il 2 settembre · in cucina gira **gen-6.03**_

> **Per scegliere:** rispondimi in chat con i numeri nell'ordine che vuoi.

## Dove siamo adesso

**In cucina** — gen-6.03 — merce già partita, CSV, doppio conteggio, peso del traffico, le dosi delle ricette, i conteggi che si rivedono, due telefoni che salvano insieme senza cancellarsi, i salvataggi che non si contano due volte, le conversioni in blocco, l'annulla che sa disfarle, il laboratorio che produce da dove legge cosa fare la Plancia che conta quello che ha toccato davvero le dosi che le scrive chi cucina il laboratorio che prepara prima e manda dopo, un piano di lavoro solo, che dice anche se gli ingredienti bastano, la frase sull'offline che dice il vero, la Memoria, le liste in ordine, la vista essenziale la revisione human factor coi tre interruttori, la Cassa col suo listino, lo storno col report di giornata, le comande alle postazioni, la lingua che dice il vero, la Cassa da banco, le postazioni assegnate ai profili le aggiunte sul piatto e l'ingrediente che si tocca in qualsiasi momento. Tutto online.

**Fatto oggi** — Due rilasci. **gen-6.02 «Le aggiunte»**: le crei in Gestione → Listino, scheda «Aggiunte», ognuna col suo prezzo, i suoi ingredienti che escono dal magazzino e i gruppi su cui vale. **gen-6.03 «L'ingrediente in mano e il nome corto»**, dalla tua correzione di stamattina. In basso ora c'è la fascia degli ingredienti e **l'ordine non conta più**: se il piatto è già nel conto la fascia dice «Su: Margherita» e il tocco ci va sopra; se non hai battuto niente l'ingrediente resta IN MANO e lo prende il primo piatto che tocchi. Per cambiare bersaglio tocchi il nome di un'altra riga, per liberarlo «Stacca». «Una margherita con la salsiccia» è passata da quattro tocchi a **due**, e l'ordine rovesciato — prima l'ingrediente — prima era impossibile. La pizza liscia resta **un tocco**. E il nome: nel Listino ogni voce ha il campo **«Cosa c'è dentro»** («mozzarella, funghi, salsiccia»), che in Cassa si legge **sotto il nome** senza toccare niente, e in cucina fra il piatto e le aggiunte. Sulla cella compaiono i nomi veri dei formati al posto della parola «varianti», e nel conto si legge «Boscaiola» sopra e «+ Salsiccia» sotto, invece di una collana. La riga battuta **non è cresciuta di un byte**. Collaudi scritti prima: 14 rossi → 44 verdi per il primo, **32 rossi → 77 verdi** per il secondo, sabotaggi contati per entrambi. Censimento completo dopo gen-6.02: 86 collaudi verdi, 1579 controlli veri, zero difetti dell'app.
