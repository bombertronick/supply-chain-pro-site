...
_Aggiornata il 31 agosto · in cucina gira **gen-5.99**_

> **Per scegliere:** rispondimi in chat con i numeri nell'ordine che vuoi.

## Dove siamo adesso

**In cucina** — gen-5.99 — merce già partita, CSV, doppio conteggio, peso del traffico, le dosi delle ricette, i conteggi che si rivedono, due telefoni che salvano insieme senza cancellarsi, i salvataggi che non si contano due volte, le conversioni in blocco, l'annulla che sa disfarle, il laboratorio che produce da dove legge cosa fare la Plancia che conta quello che ha toccato davvero le dosi che le scrive chi cucina il laboratorio che prepara prima e manda dopo, un piano di lavoro solo, che dice anche se gli ingredienti bastano, la frase sull'offline che dice il vero, la Memoria, le liste in ordine, la vista essenziale la revisione human factor coi tre interruttori, la Cassa col suo listino, lo storno col report di giornata, le comande alle postazioni e la lingua che dice il vero. Tutto online.

**Fatto oggi** — gen-5.99, «Lingua e verità» — primo rilascio del piano «veste professionale» (il tuo prompt, eseguito col metodo: 8 voci critiche sulle fotografie vere, 3 giudici avversari, ~25 correzioni confermate e 7 bocciate con motivo). In questo giro: la bugia del «tempo reale» tolta da tutte e otto le frasi (il canale è un giro di qualche secondo, e adesso c'è scritto così), i plurali veri («1 linea assegnata»), i semafori sinceri — niente bollino verde su un magazzino vuoto, la copertura bassa si chiama «critica», il sottotitolo doppio dei magazzini sistemato — la Home admin con l'allarme per primo, Ordini che non contraddice più la Home (il vuoto ammette gli articoli sotto scorta e nomina il tasto giusto), il report di giornata a righe col totale grande (via il blocco da terminale; «Copia» copia il testo di sempre), «Elimina» fuori dalle liste (vive nei fogli di modifica, dove si vede cosa si sta togliendo), la scheda «Informazioni e assistenza» con versione e limiti dichiarati, e l'identità: bottoni blu pieno (via il gradiente da template), via il joypad dalla Plancia. Collaudo scritto prima: 16 rossi su gen-5.98, 23 verdi dopo, due sabotaggi contati (semaforo del vuoto 0→1, report 0→2 — il primo sabotaggio ha morso una gemella sbagliata e ha insegnato quale delle due card il banco difende).
