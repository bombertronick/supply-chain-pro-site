...
_Aggiornata il 18 agosto · in cucina gira **gen-5.94**_

> **Per scegliere:** rispondimi in chat con i numeri nell'ordine che vuoi.

## Dove siamo adesso

**In cucina** — gen-5.94 — merce già partita, CSV, doppio conteggio, peso del traffico, le dosi delle ricette, i conteggi che si rivedono, due telefoni che salvano insieme senza cancellarsi, i salvataggi che non si contano due volte, le conversioni in blocco, l'annulla che sa disfarle, il laboratorio che produce da dove legge cosa fare la Plancia che conta quello che ha toccato davvero le dosi che le scrive chi cucina il laboratorio che prepara prima e manda dopo, un piano di lavoro solo, che dice anche se gli ingredienti bastano, la frase sull'offline che dice il vero, la Memoria, le liste in ordine e la vista essenziale per chi lavora. Tutto online.

**Fatto oggi** — Due lavori tuoi, un rilascio. gen-5.93: le liste di prodotti in ordine — per categoria e poi in alfabeto — in tutte le tendine e in tutti gli elenchi in cui si sceglie, Catalogo, magazzini, conteggi e Plancia compresi; ordinati anche fornitori e magazzini. gen-5.94: operatori e laboratorio vedono il lavoro, non la struttura — niente più aggiungi/togli articoli, soglie e livelli senza la tua autorizzazione, che accendi profilo per profilo da Gestione › Profili. Contare, rettificare, scartare, trasferire, produrre, evadere: tutto come prima. Prima di oggi erano andate online gen-5.91 (la frase dell'offline che dice il vero) e gen-5.92 (la Memoria), e il collaudo rosso da giorni si è rivelato un collaudo invecchiato, non un difetto. E stasera è nata la dispensa: il mio contesto esterno — te la spiego qui sotto, con una verità detta chiara. Restano tre migliorie e zero difetti.

**Aspetto te** — Un giro di ricarica su tutti i telefoni: chi tiene l'app aperta da ieri usa ancora la versione vecchia, che il server accetta apposta per non lasciare fuori nessuno — ma finché resta aperta può ancora sovrascrivere. Chiuderla e riaprirla basta. · Chi autorizzi alla struttura: da oggi operatori e laboratorio non possono più cambiare articoli, soglie e livelli finché non accendi la spunta sul loro profilo (Gestione › Profili). Se il tuo laboratorio deve poterlo fare, va acceso — un tocco. · I sette giorni (qui sopra) · il PIN dell'admin, che è ancora quello di partenza e va cambiato dall'app · le dosi di una ricetta, una qualsiasi, per provare il giro intero.
